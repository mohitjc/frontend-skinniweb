          ...
          <div className="flex justify-end flex-wrap gap-y-2 gap-x-2">
            <div className="flex items-center">
              ...
              <div className="relative bg-[#828282] rounded-[10px]">
                ...
                >
                  <option class="text-[#828282]" value="id">
                    Ref#
                  </option>
                  <option class="text-[#828282]" value="description">
                    Description
                  </option>
                  <option class="text-[#828282]" value="status">
                    Status
                  </option>
                  <option class="text-[#828282]" value="total">
                    Subtotal
                  </option>
                </select>
            ...
            <div className="flex items-center">
              ...
              <div className="relative bg-[#828282] rounded-[10px]">
                ...
                >
                  <option class="text-[#828282]" value="asc">
                    Ascending
                  </option>
                  <option class="text-[#828282]" value="desc">
                    Descending
                  </option>
                </select>
                <span class="absolute right-4 top-1/2 z-10 mt-[-2px] h-[10px] w-[10px] -translate-y-1/2 rotate-45 border-r-2 border-b-2 border-white"></span>
                      ...
                      <tr key={appointment.id} className="bg-white border-t">
                        ...
                        <td className="w-[100px] px-3 py-4 text-[12px]">
                          <button
                            ...
                            onClick={() =>
                              history(`/myappointmentData/${appointment.id}`)
                            }
                          >
                            View
                          </button>
