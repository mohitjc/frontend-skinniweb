...
const Zoho = () => {
  ...
  const getData = (p = {}) => {
    ...
    setLoader(true);
    const startDate = p.start_date ? `${p.start_date}T00:00:00-0700`: "";
    const endDate = p.end_date ? `${p.end_date}T23:59:59-0700` : "";
    const toDayDate = new Date();
    const newdate = moment(toDayDate).format("YYYY-DD-MM");
    const startAndEnd = `${newdate}T00:00:00-0700`;
    const endAndStart = `${newdate}T23:59:59-0700`;
    let filter = {token: accessToken, ...filters, start_date: startDate ? startDate : startAndEnd, end_date: endDate ? endDate : endAndStart,
    };  
      ...
      <div className="flex flex-wrap justify-between items-center gap-y-4">
        <div>
          ...
          <p class="text-sm font-normal text-[#75757A]">
            Here you can see all about your Zoho
          </p>
        </div>
